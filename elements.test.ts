...
Deno.test("Strings Smart 1", { permissions: "none" }, () => {
	deepStrictEqual(sortElements(["11n", "22n", "3n", "4n", "5n"], { smartNumeric: true }), ["3n", "4n", "5n", "11n", "22n"]);
});
Deno.test("Strings Smart 2", { permissions: "none" }, () => {
	deepStrictEqual(sortElements(["101n", "22", "3n", "4n", "5n"], { smartNumeric: true }), ["3n", "4n", "5n", "22", "101n"]);
});
Deno.test("Strings Smart 3", { permissions: "none" }, () => {
	const sample3 = ["sample10.png", "sample3.png", "sample2.png", "sample5.png", "sample4.png"];
	deepStrictEqual(sortElements(sample3), ["sample10.png", "sample2.png", "sample3.png", "sample4.png", "sample5.png"]);
	deepStrictEqual(sortElements(sample3, { smartNumeric: true }), ["sample2.png", "sample3.png", "sample4.png", "sample5.png", "sample10.png"]);
});
